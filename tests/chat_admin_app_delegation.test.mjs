...
test('app.js chat-tab context wrappers keep delegating to chatAdminController', async () => {
  ...
  const bindingExpectations = [
    ...
    /function\s+runChatContextAction\s*\(action,\s*event,\s*\{\s*preventDefault\s*=\s*false\s*\}\s*=\s*\{\}\)\s*\{[\s\S]*?reportUiError\(error\);[\s\S]*?\}/s,
    /chatTabContextRename\?\.addEventListener\?\.\("click",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextRenameClick,\s*event\);\s*\}\);/s,
    /chatTabContextRename\?\.addEventListener\?\.\("touchend",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextRenameClick,\s*event,\s*\{\s*preventDefault:\s*true\s*\}\);\s*\},\s*\{\s*passive:\s*false\s*\}\);/s,
    /chatTabContextPin\?\.addEventListener\?\.\("click",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextPinClick,\s*event\);\s*\}\);/s,
    /chatTabContextPin\?\.addEventListener\?\.\("touchend",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextPinClick,\s*event,\s*\{\s*preventDefault:\s*true\s*\}\);\s*\},\s*\{\s*passive:\s*false\s*\}\);/s,
    /chatTabContextClose\?\.addEventListener\?\.\("click",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextCloseClick,\s*event\);\s*\}\);/s,
    /chatTabContextClose\?\.addEventListener\?\.\("touchend",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextCloseClick,\s*event,\s*\{\s*preventDefault:\s*true\s*\}\);\s*\},\s*\{\s*passive:\s*false\s*\}\);/s,
    /chatTabContextFork\?\.addEventListener\?\.\("click",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextForkClick,\s*event\);\s*\}\);/s,
    /chatTabContextFork\?\.addEventListener\?\.\("touchend",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handleTabContextForkClick,\s*event,\s*\{\s*preventDefault:\s*true\s*\}\);\s*\},\s*\{\s*passive:\s*false\s*\}\);/s,
    /pinnedChatContextRemove\?\.addEventListener\?\.\("click",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handlePinnedContextRemoveClick,\s*event\);\s*\}\);/s,
    /pinnedChatContextRemove\?\.addEventListener\?\.\("touchend",\s*\(event\)\s*=>\s*\{\s*runChatContextAction\(handlePinnedContextRemoveClick,\s*event,\s*\{\s*preventDefault:\s*true\s*\}\);\s*\},\s*\{\s*passive:\s*false\s*\}\);/s,
