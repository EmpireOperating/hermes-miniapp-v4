    ...
    *,
    ...
    return {
        "dependencies": {
            ...
            "persistent_sessions_requested": bool(startup_routing.get("persistent_sessions_requested")),
            "persistent_sessions_enabled": bool(startup_routing.get("persistent_sessions_enabled")),
            "persistent_shared_backend_enabled": bool(startup_routing.get("persistent_shared_backend_enabled")),
            "persistent_worker_owned_enabled": bool(startup_routing.get("persistent_worker_owned_enabled")),
        ...
        "persistent": {
            "requested": bool(persistent.get("requested")),
            "enabled": bool(persistent.get("enabled")),
            "ownership": str(persistent.get("ownership") or "unknown"),
